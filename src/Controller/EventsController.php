...
class EventsController extends AbstractController
{
    ...
    #[Route('/type/{type}', name: 'app_type', methods: ['GET'])]
    public function eventsType(EventsRepository $eventsRepository, $type): Response
    {
        $events = $eventsRepository->findbyEventType($type);

        return $this->render('events/types.html.twig', ['events'=> $events]);
    }
}